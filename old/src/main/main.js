...
async function initializeApp() {
    try {
        ...
        try {
            ...
            logger.warn('ChromaDB initialization failed:', error.message);
        }
        ...
        try {
            ...
            logger.warn('AI service startup failed:', error.message);
        }
        ...
        try {
            ...
            logger.warn('Graph initialization failed:', error.message);
        }
